...
<div class="modal fade" id="delete_<?php echo $row['idPersona']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">¿Estás seguro que quieres borarar cotancto?</p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="fa fa-close"></span> Cancelar</button>
                <a href="delete.php?id=<?php echo $row['idPersona']; ?>" class="btn btn-danger"><span></span class=" fa fa-trash">Si</a>
